...
const planners_section = () => {
    ...
    return createElement('section', { className: 'w-full min-h-screen flex flex-col relative bg-[#EAEFEF]' },
        ...
        // Friendly Header
        createElement('header', { className: 'p-10 md:p-20 pb-10 relative' },
            createElement('div', { className: 'flex flex-col gap-2' },
                ...
                createElement('h1', { className: 'text-5xl md:text-6xl font-black tracking-tight text-[#25343F]' }, 'Library Room 📚'),
        ...
        createElement('div', { className: 'px-10 md:px-20 mb-16' },
            createElement('div', { className: 'bg-white p-12 rounded-[3.5rem] border border-tasklet-deep/5 flex flex-col md:flex-row gap-10 items-center overflow-hidden relative shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)]' },
                // Background Glow
                ...
                createElement('div', { className: 'w-24 h-24 bg-tasklet-cloud rounded-full flex items-center justify-center text-4xl shadow-sm border border-tasklet-deep/5 relative z-10 shrink-0 transition-transform hover:rotate-12 duration-500' }, '📋'),
                
                createElement('div', { className: 'flex-1 relative z-10' },
                    createElement('h2', { className: 'text-2xl font-black text-[#1A242B] mb-2 font-condensed tracking-tight' }, 'Template Library 🏛️'),
                    createElement('p', { className: 'text-sm font-medium text-tasklet-deep/50 leading-relaxed max-w-2xl' }, 
                ...
                createElement('div', { className: 'flex gap-3 relative z-10 shrink-0' },
                    ['📄 PDF & DOCX', '📐 A4 / Short / Long', '✨ Branded Layouts'].map(tag => 
                        createElement('span', { key: tag, className: 'px-5 py-2.5 bg-tasklet-cloud/50 rounded-2xl text-[9px] font-black text-tasklet-steel uppercase tracking-widest border border-tasklet-deep/5' }, tag)
                    )
                )
            )
        ),
        ...
        createElement('div', { className: 'px-10 md:px-20 mb-12 flex flex-col md:flex-row gap-6 items-start md:items-center' },
            createElement('div', { className: 'relative flex-1 group w-full' },
                createElement('input', {
                    ...
                    className: 'w-full bg-white border-4 border-transparent p-5 pl-14 rounded-[2rem] font-bold text-tasklet-deep placeholder:text-tasklet-deep/40 outline-none focus:border-tasklet-softblue transition-all shadow-sm'
                }),
                createElement('svg', { className: 'absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 opacity-20 group-focus-within:opacity-100 transition-opacity', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
            ...
            createElement('div', { className: 'flex flex-wrap gap-3' },
                filters.map(f => 
                    createElement('button', {
                        ...
                        className: `px-6 py-4 rounded-full text-[10px] font-black tracking-widest uppercase transition-all ${
        ...
        // Grid Container
        createElement('div', { className: 'flex-1 p-8 md:px-20 pb-48' },
